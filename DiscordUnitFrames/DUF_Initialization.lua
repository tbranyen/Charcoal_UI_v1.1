...
function DUF_Initialize_Debuffs(unit)
	...
	for i=1,16 do
		...
		local scale = button:GetScale();
		stack:SetFont("Interface\\AddOns\\DiscordUnitFrames\\CustomFonts\\DUF_Font1.ttf", stacksize);
		button:SetScale(scale + 1);
		button:SetScale(scale);
	end
...
function DUF_Initialize_VariablesFrame()
	...
	DUF_TextVariablesFrame:SetHeight(DUF_TextVariablesFrame_Column1:GetHeight() + 55);
end