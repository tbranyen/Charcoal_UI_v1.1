...
DAB_BAR_RESPONSES = {
	...
	{ text="Auto-Cast", value=110, desc="Adds an action to a queue of spells that are cast as you press movement keys.  Actions are executed in a first in, first out order.  The Unit parameter is used to specify a unit for the action to auto-target.  It must be set."},
	{ text="Remove From Auto-Cast Queue", value=111, desc="Removes all instances of the specified action from the queue of spells waiting to be auto-cast." },
	{ text="Cancel Current Spellcast", value=112, desc="Immediately cancels your current spellcast." },
...
DAB_SCRIPTS = {
	...
	{text="OnKeybindingDown", value=10, desc="Runs once when the keybinding for this object\nis pressed down."},
	{text="OnKeybindingUp", value=11, desc="Runs once when the keybinding for this object\nis released."},
