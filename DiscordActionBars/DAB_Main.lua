...
function DAB_KeybindingDown(id)
	...
	if (kb.option == 1 or kb.option == 10) then
		...
		if (button) then
			...
			DAB_Run_Script("OnKeybindingDown", "Bar", kb.suboption, button);
		end
	elseif (kb.option == 2) then
		...
		if (button) then
			...
			DAB_Run_Script("OnKeybindingDown", "Bar", bar, button);
		end
	elseif (kb.option == 3 or kb.option == 11) then
		...
		DAB_Run_Script("OnKeybindingDown", "Floaters", kb.suboption);
	elseif (kb.option == 4) then
		DAB_ControlBox_KeybindingDown(kb.suboption);
		DAB_Run_Script("OnKeybindingDown", "ControlBox", kb.suboption);
	...
	elseif (kb.option == 14) then
		local retarget;
		if (UnitName("target") and (not UnitCanAttack("player", "target"))) then
			retarget = 1;
			TargetUnit("player");
		end
		UseAction(kb.suboption);
...
function DAB_KeybindingUp(id)
	...
	if (kb.option == 1 or kb.option == 10) then
		...
		if (button) then
			...
			DAB_Run_Script("OnKeybindingUp", "Bar", kb.suboption, button);
		end
	elseif (kb.option == 2) then
		if (not DAB_Settings[DAB_INDEX].KBGroups[kb.suboption]) then return; end
		local bar = DAB_Settings[DAB_INDEX].KBGroups[kb.suboption];
		...
		if (button) then
			...
			DAB_Run_Script("OnKeybindingUp", "Bar", bar, button);
		end
	elseif (kb.option == 3 or kb.option == 11) then
		local selfcast;
		if (kb.option == 11) then
		...
		DAB_Run_Script("OnKeybindingUp", "Floaters", kb.suboption);
	elseif (kb.option == 4) then
		DAB_ControlBox_KeybindingDown(kb.suboption);
		DAB_Run_Script("OnKeybindingUp", "ControlBox", kb.suboption);
	elseif (kb.option == 5) then
		DAB_Set_KeybindingGroup(kb.suboption, kb.suboption2);
	elseif (kb.option == 6) then
		DAB_Bar_SetPage(kb.suboption, kb.suboption2);
